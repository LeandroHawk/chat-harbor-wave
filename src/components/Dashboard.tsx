...
export const Dashboard = ({ stats }: DashboardProps) => {
  const totalCategoryCount = stats.categoryCounts.rastreamento + 
    ...
    <div className="container max-w-6xl mx-auto p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.categoryCounts.rastreamento}</div>
            <p className="text-xs text-muted-foreground">Consultas sobre navios/carga</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.categoryCounts.documentacao}</div>
            <p className="text-xs text-muted-foreground">Consultas sobre documentos</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.categoryCounts.operacoes}</div>
            <p className="text-xs text-muted-foreground">Consultas operacionais</p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            {totalCategoryCount > 0 ? (
              <div className="space-y-3">
                {[
                  { label: 'Rastreamento', count: stats.categoryCounts.rastreamento },
                  { label: 'Documentação', count: stats.categoryCounts.documentacao },
              ...
              <p className="text-sm text-muted-foreground">Nenhuma consulta categorizada ainda</p>
            )}
          </CardContent>
        </Card>
      </div>
